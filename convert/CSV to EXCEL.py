...
#pandas read excel
import pandas as pd
read_Excel = pd.read_csv(r'C:\Users\Dell\PycharmProjects\pythonProject\sample.csv', encoding='UTF8') ##디렉토리 앞에 ''r'을 붙여서 unicodedecode 에러 해소
frame_Excel = pd.DataFrame(read_Excel)
frame_Excel.to_excel("CSVtest.xlsx", encoding='UTF-8', index=False) #index=False로 데이터 앞에 숫자를 출력 안함
